...
\blue{$\alpha = \frac{2eV_{1}}{2\pi f_1} << 1$ }.  This drives a current
...
Two JJ in a loop give a total current
   ...
   We see that in either case, we are working with a harmonic oscillator
   system, with corresponding raising and lowering operators.
