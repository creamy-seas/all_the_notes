...
\item      Some      complicated     transformation      that      maps
  ...
  \end{equation}
  \begin{figure}[h]
    \centering \includegraphics[height=5cm]{flux4jj_1}
  \end{figure}
...
\begin{figure}[h]
  \centering \includegraphics[height=6cm]{flux4jj_2}
\end{figure}
...
\begin{figure}[h]
  \centering \includegraphics[height=7cm]{flux4jj_3}
\end{figure}
...
\item The results are:
  ...
  \item At  the degeneracy  point, \iket{1}\ilra\iket{3}  is forbidden,
    ...
    \begin{figure}[h]
      \centering \includegraphics[height=6cm]{flux4jj_4}
    \end{figure}
  ...
  \item  For   low  $  \beta   $  all  transitions  are   supressed  except
    ...
    \begin{figure}[h]
      \centering \includegraphics[height=6cm]{flux4jj_5}
    \end{figure}
