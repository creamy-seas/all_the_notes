...
\begin{enumerate}
\item \textbf{\red{Potential  energy}} comes from all  three JJs, where
  we denote the phases
  ...
  \begin{figure}[ht]
    ...
    \caption{$\alpha$  determines  the height  of  the  barrier in  the
      middle of  the two  wells.  Larger alpha  raises the  barrier up.
  ...
  \begin{equation}
    \left\lbrace \begin{aligned}
        ...
        \vec{V} & =\left(\begin{smallmatrix} V_1\\V_2
          \end{smallmatrix}\right)\\
        C    &    =     \left(\begin{smallmatrix}    C_{01}+C_{12}    &
            -C_{12}\\-C_{12} &C_{02}+C_{12}
          \end{smallmatrix}\right)\\
