\section{Creating      a     dark      state      in     a      3-level
...
3-level system.
   ...
   \begin{figure}[h]
     \includegraphics[height = 7cm]{rfSquid1} \includegraphics[height =
     7cm]{rfSquid2}
     \caption{\iket{0}  migrates to  the  lower potential  well as  one
 ...
 eigenstates \iket{1},  \iket{2}, \iket{3},  by which the  three levels
 are labelled, can be written as
  ...
  \iket{2}\ilra\iket{3}  and \iket{1}\ilra\iket{3}  that  arise due  to
  ...
  \noindent   By  applying   a   time  dependent   \red{\textbf{unitary
      transformation}}
  ...
  contribution  from  the  \red{fast  rotating  $  2\omega^{d}_{31}  $,
    $ 2\omega^{d}_{32} $} in the  second term, since their oscillations
  ...
  the system,\footnote{For a Two-Level \iket{0}, \iket{1}, system,
  ...
  \begin{figure}
    \centering%
    \includegraphics[height=4cm]{rotwave}
    \caption{\textbf{The Rabi splitting of  the energies in a Two-Level
      ...
      states  \iket{i}  and  \iket{j}.    In  the  rotated  frame,  the
  ...
  \begin{framed}\noindent
    \noindent The  state indicated  in \red{red} is  known as  the dark
    state i.e.  completely unpopulated  \iket{1}. It happens  when both
    the       probe      (\iket{0}\ilra\iket{1})       and      control
    (\iket{1}\ilra\iket{2}) are on resonance:
