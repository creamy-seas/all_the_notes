...
\noindent\red{All superoperators in quantum mechanics can be written in
  the form}
...
\red{{\large \textbf{Important properties}
    ...
    \item If $\rho$ is Hermitian, trace 1 and non negative eigenvalues,
      then $\rho'$ has the same properties.
    \end{enumerate}
  }}
...
\begin{enumerate}
\item We work with  \red{$\rho(0)$} and \red{$\rho(\delta t)$}, instead
...
\item \textbf{System Hamiltonian}
  ...
  \red{$-\frac{i}{\hbar}\big[H_\text{eff},\   \rho(t)\big]$}    -   the
...
\item \textbf{Quantum jumps}
  ...
  \red{$\sum_{j=1}^\infty   L_j\rho(t)L_j^\dagger$}    -   irreversible
...
\red{\begin{equation}
    \begin{aligned}
      \rho(t) & = \rho_\text{ee}(t)\iketbra{e}{e} + \rho_\text{gg}(t)\iketbra{g}{g}\\
      \dot{\rho}(t)   &   =   \dot{\rho}_\text{ee}(t)\iketbra{e}{e}   +
      \dot{\rho}_\text{gg}(t)\iketbra{g}{g}
    \end{aligned}.
...
\red{\begin{equation} \dot{\rho}(t) = \left\lbrace
      \begin{aligned}
        &\dot{\rho}_\text{ee}(t)\iketbra{e}{e} + \dot{\rho}_\text{gg}(t)\iketbra{g}{g}\quad \leftarrow\text{desired soltuion}\\
        &
        -|\gamma|^2\rho_\text{ee}(t)\iketbra{e}{e}+|\gamma|^2\rho_\text{ee}(t)\iketbra{g}{g}
        \quad \leftarrow\text{Master equation}
      \end{aligned}
    \right. ,
  \end{equation}}
