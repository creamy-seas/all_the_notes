...
\noindent The eigenstate spectrum of the \iket{\pm,N} states is ladder-like (down
...
entangled states are
 ...
 \begin{framed}\noindent
   \begin{itemize}
   \item \blue{\textbf{Stark/Lambda shift}:  photon-number-dependent shift of the
       atom's                              energy                              by
       $\frac{g^{2}}{\Delta}\left( a^{\dagger}a + \frac{1}{2} \right)$};
   \item \green{\textbf{Dispersive  shift (cavity energy shifts  by $\chi$):} The
       atom ``pulls'' the cavity frequency by $ \chi = \pm g^2/\Delta $ depending
       on the atomic  state} (we can neglect  the constant offset as  it will not
...
\begin{figure}[h]
  \centering \inkfig{15cm}{ac_stark_effect_dispersive_shift}
  \caption{\small When  there is  0 detuning (right,  $\hbar\omega_{r}=\Delta E$)
    ...
    energy separation  changes by \green{$\pm\frac{g^{2}}{\Delta}$}  depending on
...
\begin{enumerate}
\item We have a qubit, that is either in state \iket{0} or \iket{1}, whose energy
...
\begin{figure}
  \centering \includegraphics[height=5cm]{probe}
...
The configuration  in Fig.\ref{qrDegen2}  is the  Mollow triplet  - it  is probed
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.45\textwidth]{qubit-resonator-interaction/qubit-resonator-anticrossing-closeup}
  \includegraphics[width=0.45\textwidth]{degen2}
...
\begin{figure}[h]
  \centering
  \includegraphics[height=6cm]{qubit-resonator-interaction/qubit-resonator-anticrossing-large-g}
  \includegraphics[height=6cm]{qubit-resonator-interaction/qubit-resonator-anticrossing}
...
\begin{figure}[h]
  \centering
  \includegraphics[height=6cm]{qubit-resonator-interaction/qubit-resonator-anticrossing-N}
  \includegraphics[height=6cm]{qubit-resonator-interaction/qubit-resonator-anticrossing-N-closeup}
...
\begin{figure}[h]
  \centering%
  \includegraphics[height=4cm]{shift} \includegraphics[height=4cm]{sfhit1}
\end{figure}
...
\noindent \red{\large \textbf{Solving for the Harmonic oscillator alone}}, with a
...
\item Solving  the Master equation  for the  continuous drive for  the stationary
  ...
  \iket{0} and \iket{1} photon states.

  \begin{figure}[h]
    \includegraphics[height=4cm]{resDen1} \includegraphics[height=4cm]{resDen2}
  \end{figure}
...
\begin{framed}\noindent
  ...
  \item Say  the resonator has  a resonance  $ n =  1 $ of  \iunit{2}{GHz}.  When
    ...
    qubit in \red{\textbf{two-tone measurements.}}
  \end{enumerate}
\end{framed}
...
\begin{framed}\noindent
  ...
  \item  Thus,  in order  to  raise  the resonator  frequency  \red{\textbf{while
        keeping the same standing wave for interaction with the qubit}}, make the
    resonator \red{\textbf{wider}}.
  \end{enumerate}
\end{framed}
...
field  where the  qubit  is at  6GHz) \red{\textbf{then  irrelevant  of what  the
    generator sweeps,  the qubit will  always be giving a  response so you  get a
    vertical white line.}}
...
\begin{enumerate}
\item For two-tone measurements, make the probe signal \red{1st tone} fairly weak
  so that there is a single photon in the resonator.

  Keep raising the power, until resonator lines become distorted.

\item The  generator signal \red{2nd  tone} should be weak  enough to get  a thin
